...
```
games/
├── registry.js          # 首页摘要注册表（本仓库提供空占位；mkregistry.mjs 生成）
...
放入自己的数据包后运行 `node tools/mkregistry.mjs` 重新生成 registry.js，
刷新首页即可看到游戏卡片。DSL 语法见 `docs/DESIGN-SPEC.md` 与 `DESIGN.md`。
