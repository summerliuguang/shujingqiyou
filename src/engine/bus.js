...
export const EV = {
  ...
  /* 能力包交互事件（bus.call 带返回值；无监听的无头环境返回 undefined，
   * 各包自行安全降级：炼丹=取消，秘境=立即撤离） */
  ALCHEMY: 'alchemy:open',        // 炼丹台开炉，监听器返回 丹方id | null(取消)
  EXPEDITION: 'expedition:layer', // 秘境单层抉择，监听器返回 {pick: 序号|'leave'}
};
